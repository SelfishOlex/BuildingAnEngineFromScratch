...
namespace Olex
{
    ...
    DemoBoxGame::DemoBoxGame( DX12App& app, UINT width, UINT height ) : m_app( app )
        , m_Viewport( CD3DX12_VIEWPORT( 0.0f, 0.0f, static_cast<float>( width ), static_cast<float>( height ) ) ), m_ScissorRect( CD3DX12_RECT( 0, 0, LONG_MAX, LONG_MAX ) )
        , m_FoV( 45.0 )
    ...
    void DemoBoxGame::LoadResources()
    {
        ...
        UpdateBufferResource( commandList.Get(),
            ...
            _countof( m_Indicies ), sizeof( WORD ), m_Indicies );
    ...
    void DemoBoxGame::TransitionResource( Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList2> commandList,
    ...
    void DemoBoxGame::ClearRTV( Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList2> commandList,
        D3D12_CPU_DESCRIPTOR_HANDLE rtv, FLOAT* clearColor )
    {
        commandList->ClearRenderTargetView( rtv, clearColor, 0, nullptr );
    }

    void DemoBoxGame::ClearDepth( Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList2> commandList,
    ...
    void DemoBoxGame::UpdateBufferResource(
    ...
    void DemoBoxGame::ThrowIfFailed( HRESULT hr )
    {
        if ( FAILED( hr ) )
        {
            throw std::exception();
