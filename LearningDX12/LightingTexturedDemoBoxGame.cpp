...
namespace Olex
{
    ...
    LightingTexturedDemoBoxGame::LightingTexturedDemoBoxGame( DX12App& app ) : BaseGameInterface( app )
    ...
    void LightingTexturedDemoBoxGame::LoadResources()
    {
    ...
    void LightingTexturedDemoBoxGame::CreateRootSignature()
    {
    ...
    void LightingTexturedDemoBoxGame::ResizeDepthBuffer( int width, int height )
    {
        if ( m_ContentLoaded )
        {
    ...
    void LightingTexturedDemoBoxGame::Resize( ResizeEventArgs args )
    {
    ...
    Microsoft::WRL::ComPtr<ID3D12Resource> LightingTexturedDemoBoxGame::LoadTextureFromFile( const wchar_t* fileName )
    {
    ...
    void LightingTexturedDemoBoxGame::UnloadResources()
    {
    }

    void LightingTexturedDemoBoxGame::Update( UpdateEventArgs args )
    {
        ...
        const XMVECTOR eyePosition = XMVectorSet( 0, -10, 0, 1 );
